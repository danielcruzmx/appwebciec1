# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-28 21:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuenta_banco', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='olimpo_movimiento_cuenta_id', to='c_olimpo.CuentaBanco')),
                ('documento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='olimpo_movimiento_documento_id', to='c_olimpo.Documento')),
        ...
        migrations.AddField(
            model_name='detallemovimiento',
            name='proveedor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.Proveedore', verbose_name='Proveedor'),
        ),
        migrations.AddField(
